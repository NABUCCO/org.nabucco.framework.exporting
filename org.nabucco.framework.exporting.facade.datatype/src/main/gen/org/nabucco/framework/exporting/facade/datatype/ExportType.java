 ...
 */
public enum ExportType implements Enumeration {
    CSV("C"),
    XML("X"), ;
    ...
    /**
     * Constructs a new ExportType instance.
     *
     * @param id the String.
     */
     ...
     */
    public static ExportType valueOfId(String literalId) {
        for (ExportType enumeration : ExportType.values()) {
