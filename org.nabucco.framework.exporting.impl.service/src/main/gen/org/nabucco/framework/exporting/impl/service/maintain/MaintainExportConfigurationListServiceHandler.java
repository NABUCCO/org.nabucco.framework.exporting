...
/**
 * MaintainExportConfigurationListServiceHandler<p/>Maintain Service for Exporting<p/>
 *
 * @version 1.0
 * @author Stefan Welsch, PRODYNA AG, 2010-08-10
 */
public abstract class MaintainExportConfigurationListServiceHandler extends PersistenceServiceHandlerSupport implements
        ServiceHandler, PersistenceServiceHandler {

    private static final long serialVersionUID = 1L;

    private static final String ID = "org.nabucco.framework.exporting.impl.service.maintain.MaintainExportConfigurationListServiceHandler";

    /** Constructs a new MaintainExportConfigurationListServiceHandler instance. */
    public MaintainExportConfigurationListServiceHandler() {
        super();
    }
    ...
    protected ServiceResponse<ExportConfigurationListMsg> invoke(ServiceRequest<ExportConfigurationListMsg> rq)
        ...
        try {
            ...
            msg = this.maintainExportConfigurationList(rq.getRequestMessage());
            if ((msg == null)) {
     ...
     * @throws MaintainException
     */
    protected abstract ExportConfigurationListMsg maintainExportConfigurationList(ExportConfigurationListMsg msg)
            throws MaintainException;
