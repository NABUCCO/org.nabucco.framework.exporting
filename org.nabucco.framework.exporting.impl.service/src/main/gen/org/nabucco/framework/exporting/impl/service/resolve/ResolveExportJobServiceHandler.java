...
/**
 * ResolveExportJobServiceHandler<p/>Resolve Service for Exporting<p/>
 *
 * @version 1.0
 * @author Stefan Welsch, PRODYNA AG, 2010-08-10
 */
public abstract class ResolveExportJobServiceHandler extends PersistenceServiceHandlerSupport implements
        ServiceHandler, PersistenceServiceHandler {

    private static final long serialVersionUID = 1L;

    private static final String ID = "org.nabucco.framework.exporting.impl.service.resolve.ResolveExportJobServiceHandler";

    /** Constructs a new ResolveExportJobServiceHandler instance. */
    public ResolveExportJobServiceHandler() {
        super();
    }
     ...
     */
    protected ServiceResponse<ExportJobMsg> invoke(ServiceRequest<ExportJobMsg> rq) throws ResolveException {
     ...
     * @throws ResolveException
     */
    protected abstract ExportJobMsg resolveExportJob(ExportJobMsg msg) throws ResolveException;
