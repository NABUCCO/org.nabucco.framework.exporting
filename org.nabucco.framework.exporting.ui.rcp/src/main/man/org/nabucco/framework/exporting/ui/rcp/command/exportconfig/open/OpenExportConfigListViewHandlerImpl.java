...
import org.nabucco.framework.exporting.ui.rcp.command.exportconfig.open.OpenExportConfigListViewHandler;
...
/**
 * OpenExportConfigListViewHandlerImpl
 * 
 * @author Christian Nicolaus, PRODYNA AG
 */
public class OpenExportConfigListViewHandlerImpl
        extends
        AbstractNabuccoOpenCorrespondingListViewHandlerImpl<ExportConfigurationListViewBrowserElement, ExportConfigurationListViewModel>
        implements OpenExportConfigListViewHandler {

    @Override
    public void openExportConfigListView() {
        super.run();
    }
