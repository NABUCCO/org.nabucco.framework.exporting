...
/**
 * ExportConfigurationListView<p/>ListView for ExportConfiguration<p/>
 *
 * @author Christian Nicolaus, PRODYNA AG, 2010-08-20
 */
public class ExportConfigurationListView extends NabuccoComponentListView<ExportConfigurationListViewModel> {

    public static final String ID = "org.nabucco.framework.exporting.ui.list.exportconfig.ExportConfigurationListView";

    public static final String TAB_TITLE = (ID + ".tabTitle");

    public static final String TITLE = (ID + ".title");

    /** Constructs a new ExportConfigurationListView instance. */
    public ExportConfigurationListView() {
        super();
        model = new ExportConfigurationListViewModel();
    }
