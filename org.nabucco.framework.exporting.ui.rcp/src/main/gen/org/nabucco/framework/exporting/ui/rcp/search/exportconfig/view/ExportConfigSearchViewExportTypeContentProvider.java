...
/**
 * ExportConfigSearchViewExportTypeContentProvider<p/>search view for an export configuration<p/>
 *
 * @author Christian Nicolaus, PRODYNA AG, 2010-08-20
 */
public class ExportConfigSearchViewExportTypeContentProvider implements ElementPickerContentProvider {

    /** Constructs a new ExportConfigSearchViewExportTypeContentProvider instance. */
    public ExportConfigSearchViewExportTypeContentProvider() {
        super();
    }
