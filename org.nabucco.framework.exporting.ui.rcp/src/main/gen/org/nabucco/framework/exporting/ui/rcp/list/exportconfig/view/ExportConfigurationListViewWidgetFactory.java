...
/**
 * ExportConfigurationListViewWidgetFactory<p/>ListView for ExportConfiguration<p/>
 *
 * @author Christian Nicolaus, PRODYNA AG, 2010-08-20
 */
public class ExportConfigurationListViewWidgetFactory extends WidgetFactory {

    /**
     * Constructs a new ExportConfigurationListViewWidgetFactory instance.
     *
     * @param nabuccoFormToolKit the NabuccoFormToolkit.
     */
    public ExportConfigurationListViewWidgetFactory(NabuccoFormToolkit nabuccoFormToolKit) {
